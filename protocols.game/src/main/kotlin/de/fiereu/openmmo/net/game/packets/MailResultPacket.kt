...
/**
 * the official client `the official client`: one `sj1` byte. The values are `sj1.Y90`; 0 is "sent
 * successfully", 4 is "recipient not found", 15 is "cannot send to yourself".
 */
